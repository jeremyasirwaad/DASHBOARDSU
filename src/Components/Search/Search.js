...
export const Search = () => {
	...
	useEffect(() => {
		applyfilter();
	},[isit,iscse,isece,iseee,iscivil,ismech,isibt,isprod,isfullstack,isdataengineer,isdatascience,isDataVisualization,isintern,isparttime,isfulltime,stirange,searchWord])
	...
	return (
		<div>
				...
				<div className="sidefiltercont">
					...
					<div className="filterobjects">
						<div className="departmentobj">
							...
							<div className="fildepartchoice">
								<div className="departch1">
									<input type="checkbox" name="CSE" onChange={(e) => { setIscse(e.target.checked)  }} />
									<label htmlFor="CSE">CSE</label>
									<input type="checkbox" name="CSE" onChange={(e) => { setIsit(e.target.checked)  }} />
									<label htmlFor="CSE">IT</label>
									<input type="checkbox" name="CSE" onChange={(e) => { setIsece(e.target.checked)  }} />
									<label htmlFor="CSE">ECE</label>
									<input type="checkbox" name="CSE" onChange={(e) => { setIseee(e.target.checked)  }} />
									<label htmlFor="CSE">EEE</label>
								</div>
								<div className="departch2">
									<input type="checkbox" name="CSE" onChange={(e) => { setIsibt(e.target.checked)  }} />
									<label htmlFor="CSE">IBT</label>
									<input type="checkbox" name="CSE" onChange={(e) => { setIsmech(e.target.checked)  }} />
									<label htmlFor="CSE">Mech</label>
									<input type="checkbox" name="CSE" onChange={(e) => { setIscivil(e.target.checked)  }} />
									<label htmlFor="CSE">Civil</label>
									<input type="checkbox" name="CSE" onChange={(e) => { setIsprod(e.target.checked)  }} />
						...
						<div className="stipendobj">
							<span>Stipend</span>
							<div className="slimf" style ={{ width:"100%", display: "flex", justifyContent: "center"}}>
						...
						<div className="typeofjobobj">
							...
							<div className="typeofchoicecontainer">
								<div style={{ marginBottom: "4px" }}>
									<input type="checkbox" name="FullStack" checked = {isfullstack} onChange={(e) => { setIsdataengineer(false); setIsdatascience(false); setIsDataVisualization(false); setIsfullstack(e.target.checked) }} />
									<label htmlFor="FullStack">FullStack</label>
								</div>
								<div style={{ marginBottom: "4px" }}>
									<input type="checkbox" name="DataScience" checked = {isdatascience} onChange={(e) => { setIsdataengineer(false); setIsfullstack(false); setIsDataVisualization(false); setIsdatascience(e.target.checked) }} />
									<label htmlFor="DataScience">Data Science</label>
								</div>
								<div style={{ marginBottom: "4px" }}>
									<input type="checkbox" name="DataEngineering" checked = {isdataengineer} onChange={(e) => {setIsdatascience(false); setIsfullstack(false); setIsDataVisualization(false); setIsdataengineer(e.target.checked) }} />
									<label htmlFor="DataEngineering">Data Engineering</label>
								</div>
								<div style={{ marginBottom: "4px" }}>
									<input type="checkbox" name="DataVisualization" checked = {isDataVisualization} onChange={(e) => {setIsdataengineer(false); setIsfullstack(false); setIsdatascience(false); setIsDataVisualization(e.target.checked) }} />
						...
						<div className="jobtobj">
							...
							<div className="jobtcont">
								<div style={{ marginBottom: "4px" }}>
									<input type="checkbox" checked = {isintern} name="FullStack" onChange={(e) => { setIsparttime(false); setIsfulltime(false); setIsintern(e.target.checked) }}/>
									<label htmlFor="FullStack">Internship</label>
								</div>
								<div style={{ marginBottom: "4px" }}>
									<input type="checkbox" name="DataScience" checked = {isparttime}  onChange={(e) => {setIsintern(false); setIsfulltime(false); setIsparttime(e.target.checked) }} />
									<label htmlFor="DataScience">Part-Time</label>
								</div>
								<div style={{ marginBottom: "4px" }}>
									<input type="checkbox" name="DataEngineering" checked = {isfulltime}  onChange={(e) => {setIsintern(false); setIsparttime(false); setIsfulltime(e.target.checked) }} />
			...
			>
				{sidefilteropen ? (
					<i
						class="fa-solid fa-angles-right arrow"
						style={{ marginRight: "10px", color: "blueviolet" }}
					></i>
				) : (
					<>
						<i
							style={{ marginRight: "10px", color: "blueviolet" }}
							class="fa-solid fa-angles-left arrow"
						></i>
						{/* <i class="fa-solid fa-filter iconfil "></i> */}
					</>
				)}
			</div>
